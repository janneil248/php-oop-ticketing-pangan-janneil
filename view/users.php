                            ...
                            <div class="table-responsive table-billing-history">
                                ...
                                <?php foreach($result as $row) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="badge bg-secondary text-white">Inactive</span></td>
                                        </tr>
                                        <tr>
                                            <td>Gemeja Manalo</td>
                                            <td>gemeja@gmail.com</td>
                                            <td>User</td>
                                            <td>
                                                <span class="badge badge-success">IT</span>
                                            </td>
                                        ...
                                        <tr>
                                            <td>Rendel Mallari</td>
                                            <td>rendel@gmail.com</td>
                                            <td>Admin</td>
                                            <td>
                                                <span class="badge badge-danger">Maintenance</span>
                                                <span class="badge badge-warning">Housekeeping</span>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="badge bg-secondary text-light">Inactive</span></td>
                                        </tr>
                                        <tr>
                                            <td>Neil Pangan</td>
